...
func (s *Server) RegisterRoutes() http.Handler {
	...
	ticketService := service.NewTicketService(s.db, roomTicketService, llmService, websocketService)
	...
	newTicketRouter(ticketService, jiraService, s.db.DB, e.Group("/ticket"))
