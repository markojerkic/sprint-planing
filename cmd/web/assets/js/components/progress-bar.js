...
class HtmxProgressBar extends HTMLElement {
	...
	connectedCallback() {
		...
		document.addEventListener("htmx:responseError", this.handleRequestError);
	}
	...
	disconnectedCallback() {
		...
		document.removeEventListener("htmx:afterRequest", this.handleAfterRequest);
		document.removeEventListener("htmx:responseError", this.handleRequestError);
	...
	initializeAttributes() {
		...
		this.updateProgressBarColor(this.getAttribute("color") || THEME.PRIMARY);
